...
\_,_// .__/\__/ \___//_/ \_,_/ \__//_/ |_|/_/   /_/|_| \_,_/ \___/|__,__//_//_//_/ \___/\_,_/ \_,_/ \__//_/   
    ...
    parser.add_argument('-f', '--file', help='Input file that contains the list of MD5 identifiers of the Aptoide apps to search and download (default filename is ./apks.txt).', action='store', dest='file', nargs=1, default='apks.txt')
    parser.add_argument('-m', '--md5', help='The MD5 id of the app to download!', action='store', dest='md5', nargs=1, default='')
    args = parser.parse_args()

    print(args)

    if args.file == '' and args.md5 == '':
        print("No arguments were used... please use -h option to display help!")
        exit(0)

    if args.md5:
        download_apk(args.md5[0])
